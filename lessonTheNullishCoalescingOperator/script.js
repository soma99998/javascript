...
function onlineContentProperty(array) {
  for (let i = 0; i < array[7]; i++)
    array[i].onlineContent ??
      console.log(
        `${array[i].title} provides no data about its online content`
      );
}
onlineContentProperty(books);
