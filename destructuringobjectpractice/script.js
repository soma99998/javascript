...
// with the value of the keywords property.
...
//Please do most of the work on the left
// side of the assignment operator: const ... = books[0];
const {
  thirdParty: {
...
//Write a function called printBookInfo that has three parameters called
// title, author and year. This function should work for a single object
// passed as an argument, and it should log to the console information about
//  the book in this format: "${title} by ${author}, ${year}".
...
function printBookInfo({ title, author, year }) {
  console.log(`${title} by ${author}, ${(year = "unknown")}`);
}
printBookInfo({ title: "rrr", author: "jjj" });
